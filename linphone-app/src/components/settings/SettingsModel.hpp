...
public:
	...
	bool isReadOnly(const std::string& section, const std::string& name);
	std::string getEntryFullName(const std::string& section, const std::string& name);	// Return the full name of the entry : 'name/readonly' or 'name'
